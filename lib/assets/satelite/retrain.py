...
MODEL_DIR = './inception'
IMAGE_DIR = './images/jpg_images'  # 待训练图片地址
OUT_GRAPH = OUTPUT_DIR+'satellite_graph.pb'  # 输出计算图
OUT_LABELS = OUTPUT_DIR+'satellite_labels.txt'  # 训练分类
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default=OUTPUT_DIR+'tmp/retrain_logs',
